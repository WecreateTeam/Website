...
const productData = {
	...
	'2': {
		...
		connectionInstructions:
			'Connect to our test server at policemdttest.wecreateserver.com and use the command /mdt to access the system.',
		videoThumbnail: 'https://via.placeholder.com/1280x720',
	...
	return (
		<Box
			...
			<Container maxWidth="lg" sx={{ flex: 1 }}>
				{' '}
				{/* Add flex: 1 to push footer to bottom */}
				<Grid container spacing={4}>
					...
					<Grid item xs={12} md={6}>
						...
						<Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
							...
							<Button variant="outlined" size="small" color="info" startIcon={<CheckIcon />}>
								QBCore
							</Button>
						</Box>
				...
				<Box sx={{ mt: 8, position: 'relative', cursor: 'pointer' }}>
					<img src={product.videoThumbnail} alt="Video thumbnail" style={{ width: '100%', borderRadius: '12px' }} />
					<Box
						sx={{
							position: 'absolute',
							top: '50%',
