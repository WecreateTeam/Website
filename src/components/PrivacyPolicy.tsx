			...
			<Container maxWidth="md" sx={{ flexGrow: 1 }}>
				<Box sx={{ padding: 10, my: 4 }}>
					...
					<Typography variant="body1" paragraph>
						Tebex Limited respects your privacy and is committed to protecting your personal data. This privacy notice
					...
					<ol>
						<li>
							<Link href="#important-info">Important Information and Who We Are</Link>
						</li>
						<li>
							<Link href="#data-we-collect">The Data We Collect About You</Link>
						</li>
						<li>
							<Link href="#how-collected">How Is Your Personal Data Collected?</Link>
						</li>
						<li>
							<Link href="#how-we-use">How We Use Your Personal Data</Link>
						</li>
						<li>
							<Link href="#disclosures">Disclosures of Your Personal Data</Link>
						</li>
						<li>
							<Link href="#international-transfers">International Transfers</Link>
						</li>
						<li>
						...
						<li>
							<Link href="#your-rights">Your Legal Rights</Link>
						</li>
						<li>
					...
					<Typography variant="body1" paragraph>
						...
						through your use of www.tebex.io and www.buycraft.net (together referred to as "this website"), and also any
						associated webstore (a "Webstore") which utilities the Tebex webstore platform for game servers (the "Tebex
						Platform"), including any data you may provide through this website when you purchase a product or service.
					</Typography>
					...
					<Typography variant="body1" paragraph>
						Tebex Limited is the controller and responsible for your personal data (collectively referred to as "Tebex",
					...
					<Typography variant="body1" component="div">
						<ul>
							...
							<li>
								Postal address: Tebex Limited, Levy Cohen & Co, 5.2 Central House, 1 Ballards Lane, London, United
								Kingdom, N3 1LQ
							</li>
						</ul>
					</Typography>
					...
					<Typography variant="body1" paragraph>
						...
						any purpose. Aggregated Data may be derived from your personal data but is not considered personal data in
						law as this data does not directly or indirectly reveal your identity. For example, we may aggregate your
					...
					<Typography variant="body1" paragraph>
						...
						Tebex group of companies for marketing purposes.
					</Typography>
					...
					<Typography variant="body1" paragraph>
						...
						inaccessible or not function properly. For more information about the cookies we use, please see our cookie
						policy.
					</Typography>
					...
					<Typography variant="body1" paragraph>
						We share your personal data within the Tebex Group. This will involve transferring your data outside the
						European Economic Area (EEA).
					</Typography>

					<Typography variant="body1" paragraph>
						Many of our external third parties are based outside the European Economic Area (EEA) so their processing of
					...
					<Typography variant="body1" component="div">
						<ul>
							<li>
								<Link href="#request-access">Request access to your personal data</Link>
							</li>
							<li>
								<Link href="#request-correction">Request correction of your personal data</Link>
							</li>
							<li>
								<Link href="#request-erasure">Request erasure of your personal data</Link>
							</li>
							<li>
								<Link href="#object-processing">Object to processing of your personal data</Link>
							</li>
							<li>
								<Link href="#request-restriction">Request restriction of processing your personal data</Link>
							</li>
							<li>
								<Link href="#request-transfer">Request transfer of your personal data</Link>
							</li>
							<li>
								<Link href="#right-withdraw">Right to withdraw consent</Link>
							</li>
						</ul>
					</Typography>
					...
					<Typography variant="body1" paragraph>
						Other companies in the Tebex Group acting as joint controllers or processors and who are based in the United
						Kingdom and provide IT and system administration services and undertake leadership reporting.
					</Typography>
					...
					<Typography variant="body1" component="div">
						<ul>
							...
							<li id="request-restriction">
								<strong>Request restriction of processing</strong> of your personal data. This enables you to ask us to
								suspend the processing of your personal data in the following scenarios: (a) if you want us to establish
								the data's accuracy; (b) where our use of the data is unlawful but you do not want us to erase it; (c)
							...
							<li id="request-transfer">
								<strong>Request the transfer</strong> of your personal data to you or to a third party. We will provide
							...
							<li id="right-withdraw">
								<strong>Withdraw consent at any time</strong> where we are relying on consent to process your personal
