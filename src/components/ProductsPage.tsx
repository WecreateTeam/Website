			...
			<Container maxWidth="lg" sx={{ flex: 1 }}>
				...
				<Box
					...
					<FormControl variant="outlined" sx={{ width: { xs: '100%', sm: '30%' } }}>
						<InputLabel id="products-label" sx={{ color: '#888' }}>
							All Products
						</InputLabel>
						<Select
					...
					<FormControl variant="outlined" sx={{ width: { xs: '100%', sm: '30%' } }}>
						<InputLabel id="category-label" sx={{ color: '#888' }}>
							All Categories
						</InputLabel>
						<Select
				...
				<Grid container spacing={3}>
					{filteredItems.map(
						({ id, image, title, category, price, tag, description, features, isAvailable, buyNowLink }, index) => (
